// Remove the hardcoded ACCESS_TOKEN line and replace with this:
let ACCESS_TOKEN = '';
...
async function initializeMapbox() {
  try {
    ...
    // Initialize the map after getting the token
    initializeMap();
  } catch (error) {
...
// Move your map initialization into this function
...
// Call this when the page loads instead of immediately initializing the map
...
// Update the reZoomMap function to use window.map
...
// Update fetchAndDisplayMarkers to use window.map
async function fetchAndDisplayMarkers() {
  try {
    ...
    // Your existing code for building GET_REQUEST...
...
// (closeCustomPopup, initAutocomplete, convertTime, openCustomPopup, etc.)
